...
export class HttpSettingsService {
  private readonly authSettingsSubject: BehaviorSubject<IAuthEnable>;
  public url = environment.baseUrl;

  constructor(private http: HttpClient, private auth: AuthService) {
    this.authSettingsSubject = new BehaviorSubject<IAuthEnable>(null);
  }

  public get getAuthEnable(): Subject<IAuthEnable> {
